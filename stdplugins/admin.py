...
STRING_TOO_SMALL = "`The image is too small`"
STRING_ERROR = "`Failure while processing the image`"
STRING_NO_ADMIN = "`I am not an admin!`"
STRING_NO_PERMS = "`I don't have sufficient permissions!`"
STRING_NO_SQL = "`Running on Non-SQL mode!`"

STRING_CHAT_PP_CHANGED = "`Chat Picture Changed`"
STRING_CHAT_PP_ERROR = "`Some issue with updating the pic,`" \
                "`maybe coz I'm not an admin,`" \
                "`or don't have enough rights.`"
STRING_INVALID_MEDIA = "`Invalid Extension`"
...
async def set_group_photo(gpic):
    ...
    if not gpic.text[0].isalpha() and gpic.text[0] not in ("/", "#", "@", "!"):
        ...
        if not admin and not creator:
            await gpic.edit(STRING_NO_ADMIN)
            return
        ...
        if replymsg and replymsg.media:
            if isinstance(replymsg.media, MessageMediaPhoto):
                ...
                await gpic.edit(STRING_INVALID_MEDIA)
        ...
        if photo:
            try:
                ...
                await gpic.edit(STRING_CHAT_PP_CHANGED)

            except PhotoCropSizeSmallError:
                await gpic.edit(STRING_TOO_SMALL)
            except ImageProcessFailedError:
                await gpic.edit(STRING_ERROR)
...
async def promote(promt):
    ...
    if not promt.text[0].isalpha() \
        ...
        if not admin and not creator:
            await promt.edit(STRING_NO_ADMIN)
            return
        ...
        await promt.edit("`Promoting this guy...`")
        ...
        try:
            ...
            await promt.edit("`Promoted Successfully! Thank` [cHAuHaN](http://t.me/amnd33p)")

        # If Telethon spit BadRequestError, assume
        # we don't have Promote permission
        except BadRequestError:
            await promt.edit(STRING_NO_PERMS)
            return
...
async def demote(dmod):
    ...
    if not dmod.text[0].isalpha() and dmod.text[0] not in ("/", "#", "@", "!"):
        ...
        if not admin and not creator:
            await dmod.edit(STRING_NO_ADMIN)
            return
        ...
        # Assume we don't have permission to demote
            ...
            await dmod.edit(STRING_NO_PERMS)
            return
...
async def ban(bon):
    ...
    if not bon.text[0].isalpha() and bon.text[0] not in ("/", "#", "@", "!"):
        ...
        # Well
        if not admin and not creator:
            await bon.edit(STRING_NO_ADMIN)
            return
        ...
        try:
            ...
            await bon.edit(STRING_NO_PERMS)
            return
...
async def nothanos(unbon):
    ...
    if not unbon.text[0].isalpha() and unbon.text[0] \
        ...
        # Well
        if not admin and not creator:
            await unbon.edit(STRING_NO_ADMIN)
            return
...
async def spider(spdr):
    ...
    if not spdr.text[0].isalpha() and spdr.text[0] not in ("/", "#", "@", "!"):
        ...
        if not admin and not creator:
            await spdr.edit(STRING_NO_ADMIN)
            return
...
async def unmoot(unmot):
    ...
    if not unmot.text[0].isalpha() and unmot.text[0] \
        ...
        # If not admin and not creator, return
        if not admin and not creator:
            await unmot.edit(STRING_NO_ADMIN)
            return
        ...
        try:
            ...
            await unmot.edit(STRING_NO_SQL)
            return
...
async def ungmoot(un_gmute):
    ...
    if not un_gmute.text[0].isalpha() and un_gmute.text[0] \
        ...
        # If not admin and not creator, return
        if not admin and not creator:
            await un_gmute.edit(STRING_NO_ADMIN)
            return
        ...
        try:
            ...
            await un_gmute.edit(STRING_NO_SQL)
            return
...
async def gspider(gspdr):
    ...
    if not gspdr.text[0].isalpha() and gspdr.text[0] not in ("/", "#", "@", "!"):
        ...
        # If not admin and not creator, return
        if not admin and not creator:
            await gspdr.edit(STRING_NO_ADMIN)
            return
        ...
        try:
            ...
            await gspdr.edit(STRING_NO_SQL)
            return
...
async def pin(msg):
    ...
    if not msg.text[0].isalpha() and msg.text[0] not in ("/", "#", "@", "!"):
        ...
        # If not admin and not creator, return
        if not admin and not creator:
            await msg.edit(STRING_NO_ADMIN)
            return
        ...
        try:
            ...
            await msg.edit(STRING_NO_PERMS)
            return
...
async def kick(usr):
    ...
    if not usr.text[0].isalpha() and usr.text[0] not in ("/", "#", "@", "!"):
        ...
        # If not admin and not creator, return
        if not admin and not creator:
            await usr.edit(STRING_NO_ADMIN)
            return
        ...
        try:
            ...
            await usr.edit(STRING_NO_PERMS)
            return
        await usr.client(
            EditBannedRequest(
                usr.chat_id,
