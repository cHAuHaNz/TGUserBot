...
@borg.on(admin_cmd(pattern=f"{borg.me.id}gmute(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern=f"{borg.me.id}ungmute(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern=f"{borg.me.id}delusers(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern=f"{borg.me.id}adminlist$", allow_sudo=True))
...
@borg.on(admin_cmd(pattern=f"{borg.me.id}userslist ?(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern=f"{borg.me.id}undlt$", allow_sudo=True))
