...
@borg.on(admin_cmd(pattern="ssetgpic$", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="spromote(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="sdemote(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="sban(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="sunban(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="smute(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="sunmute(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="sgmute(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="sungmute(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="sdelusers(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="sadminlist$", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="sbots$", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="spin(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="skick(?: |$)(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="suserslist ?(.*)", allow_sudo=True))
...
@borg.on(admin_cmd(pattern="sundlt$", allow_sudo=True))
