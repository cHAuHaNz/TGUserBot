...
async def _(event):
    ...
    if not reply_message.media:
       await event.edit("```Reply to an image or sticker```")
       return
    chat = "@MemeAutobot"
    ...
    if reply_message.sender.bot:
     ...
     await event.edit("```Please wait.....Memification in process.....```")
    ...
    async with borg.conversation("@MemeAutobot") as bot_conv:
          ...
          if "Okay..." in response.text:
            await event.edit("```This is a sticker! This will take some time....```")
            ...
            await event.edit("Invalid message type. Please choose right message type.")
            return
          else: 
               await borg.send_file(event.chat_id, response.media)
